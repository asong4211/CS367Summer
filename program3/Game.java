...
public class Game {
     ...
     * 
     * To get a random integer in the range [0,n):
     *    int rVal = Game.RNG.nextInt(n);           // rval may be 0, but will be less than n 
     */
    ...
    public void init(String configFilename, String areaFilename) 
